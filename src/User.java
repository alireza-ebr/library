...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return age == user.age && id == user.id && Objects.equals(name, user.name) && Objects.equals(address, user.address) && Objects.equals(gender, user.gender) && Objects.equals(password, user.password);
    }
